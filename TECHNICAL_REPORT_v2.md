...
- **Baseline Comparison**: 60-72% accuracy for traditional statistical tests (ADF, KPSS, Phillips-Perron)
- **Training Efficiency**: Complete pipeline execution in under 30 minutes

The hierarchical approach significantly outperforms traditional statistical tests while providing detailed pattern recognition capabilities for non-stationary time series.
...
#### 4.2.4 Model 1 Confusion Matrix

![Model 1 Confusion Matrices](04-postprocessing/figures/confusion_matrices_model1.png)
...
#### 4.3.4 Model 2 Confusion Matrix

![Model 2 Confusion Matrices](04-postprocessing/figures/confusion_matrices_model2.png)
...
| Traditional ADF | Binary | Statistical Test | 60.80% | 13K synthetic |
| Traditional KPSS | Binary | Statistical Test | 71.83% | 13K synthetic |
...
1. **State-of-the-Art Performance**:
   ...
   - 25% absolute improvement over traditional statistical tests
...
1. **Confusion Matrices**:
   - [confusion_matrices_model1.png](04-postprocessing/figures/confusion_matrices_model1.png) - Binary classification confusion matrices
   - [confusion_matrices_model2.png](04-postprocessing/figures/confusion_matrices_model2.png) - 5-class classification confusion matrices
...
*For questions or collaboration: [iguzel@example.com]*
